...
IMPORTANT FOR MIXAMO USERS: If you wish to download FREE animations from MIXAMO left all settings in "DOWNLOAD SETTINGS" window by default, do not change them, otherwise you can recive broken animation with wrong rotations, if you will select "Without skin" - avatar goes to be broken.